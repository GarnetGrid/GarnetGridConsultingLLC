# ALL function (DAX) - DAX

**Source:** https://learn.microsoft.com/en-us/dax/all-function-dax
**Captured:** 2026-02-02
**Domain:** powerbi
...
1. The numerator, `SUMX(ResellerSales_USD, ResellerSales_USD[SalesAmount_USD])`, is the sum of the values in ResellerSales\_USD[SalesAmount\_USD] for the current cell in the PivotTable, with context filters applied on CalendarYear and ProductCategoryName.
