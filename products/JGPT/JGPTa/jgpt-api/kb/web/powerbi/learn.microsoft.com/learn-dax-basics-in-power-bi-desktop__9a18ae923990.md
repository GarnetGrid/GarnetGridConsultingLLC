...
Let’s go over a few more things about this formula. In particular, we introduced a function, [SUM](/en-us/dax/sum-function-dax). Functions are pre-written formulas that make it easier to do complex calculations and manipulations with numbers, dates, time, text, and more. You'll learn more about functions later.
...
* This formula included two functions. [PREVIOUSQUARTER](/en-us/dax/previousquarter-function-dax), a time intelligence function, is nested as an argument passed to [CALCULATE](/en-us/dax/calculate-function-dax), a filter function.
...
DAX includes the following categories of functions: [Date and Time](/en-us/dax/date-and-time-functions-dax), [Time Intelligence](/en-us/dax/time-intelligence-functions-dax), [Information](/en-us/dax/information-functions-dax), [Logical](/en-us/dax/logical-functions-dax), [Mathematical](/en-us/dax/math-and-trig-functions-dax), [Statistical](/en-us/dax/statistical-functions-dax), [Text](/en-us/dax/text-functions-dax), [Parent/Child](/en-us/dax/parent-and-child-functions-dax), and [Other](/en-us/dax/other-functions-dax) functions. If you’re familiar with functions in Excel formulas, many of the functions in DAX will appear similar to you; however, DAX functions are unique in the following ways:
...
* Excel has a popular function, VLOOKUP. DAX functions don’t take a cell or cell range as a reference like VLOOKUP does in Excel. DAX functions take a column or a table as a reference. Keep in mind, in Power BI Desktop you’re working with a relational data model. Looking up values in another table is easy, and in most cases you don’t need to create any formulas at all.
  ...
  As you can see, functions in DAX can help you create powerful formulas. We only touched on the basics of functions. As your DAX skills grow, you'll create formulas by using many different functions. One of the best places to learn details about each of the DAX functions is in the [DAX Function Reference](/en-us/dax/).
...
3. [Text functions](/en-us/dax/text-functions-dax).
