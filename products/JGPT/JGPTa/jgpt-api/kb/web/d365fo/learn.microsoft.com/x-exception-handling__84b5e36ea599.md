...
**Source:** https://learn.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/dev-ref/xpp-exceptions
**Captured:** 2026-02-02
**Domain:** d365fo
...
| [SQL connection error X++ exception](sql-connection-error) | An error occurred when during the query execution. The transaction will be canceled. This exception can't be caught within a transaction. |
