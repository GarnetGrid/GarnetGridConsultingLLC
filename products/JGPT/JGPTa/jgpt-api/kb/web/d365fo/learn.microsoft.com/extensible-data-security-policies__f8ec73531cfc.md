...
**Source:** https://learn.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/sysadmin/extensible-data-security-policies
**Captured:** 2026-02-03
**Domain:** d365fo
...
* **Context** â Controls the conditions under which a policy is applicable.
  ...
  + **Role context**: Based on the roles that the user is assigned. There are
    ...
    - **RoleName** â Indicates that the security policy is only applied to
      the application user assigned to the role equal to the value of
      RoleName.
    - **RoleProperty** â This value is used in combination with the
...
2012]](/en-us/dynamicsax-2012/appuser-itpro/developing-extensible-data-security-policies-white-paper).
...
For example, [Create a simple security policy](create-simple-security-policy).
